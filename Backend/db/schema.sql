...
-- =============================================================================
-- Seed data: AI pen-pals (ai_characters + one active prompt each)
-- =============================================================================
-- Kept here so a fresh database is fully usable after one run (tables + the AI
-- pen-pals the assignment/worker jobs need). Idempotent, and mirrored in
-- Backend/db/seed_ai_characters.sql (run that alone to update an existing DB)
-- and Backend/scripts/seed_ai_characters.py. Keep all three in sync.
